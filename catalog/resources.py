...
class DevicelistResource(resources.ModelResource):
    ...
    class Meta:
        ...
        model = Device
        fields = ('hostname', 'customer', 'model', 'serialn', 'tag', 'type', 'location', 'buydate', 'status', 'substatus', 'warranty', 'cost')
        exclude = ('id', )
        import_id_fields = ('hostname', 'customer', 'model', 'serialn', 'tag', 'type', 'location', 'buydate', 'status', 'substatus', 'warranty', 'cost')
